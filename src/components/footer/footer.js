  ...
  <footer className="d-none d-md-block">
    <div className="container pt-5 pb-5">
      <div className="row">
        ...
        <div className="col-3">
          <div className="foot-heading">Contact Us</div>
          <div className="linked-num"><a href="https://api.whatsapp.com/send?phone=923095360060" target='_blank'>+92 309 5360060</a></div>
        </div>
      </div>
    </div>
    ...
    <div className="container py-5">
      <div className="row">
        <div className="col-2">
          <img
            src={logo}
            className="d-block pl-2 img-fluid"
            alt="Trango"
          />
        </div>
        <div className="col-5">
